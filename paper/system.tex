...
\begin{figure}[h!]
\centering 
\includegraphics[width=0.45\textwidth]{pics/browse.png}
\caption{Browse for shows and add them to your WatchBox.}
\label{fig:model1}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{pics/watchbox.png}}
\caption{Add shows from the WatchBox to your playlist.}
\label{fig:model2}
\end{figure}
...
\caption{Viewer chooses from a mood to generate a genre-specific playlist.}
\end{figure}

\begin{figure}[h!]
\centering 
\label{fig:model4}
\includegraphics[width=0.45\textwidth]{pics/choosefriends.png}}
\caption{Viewer chooses a mood to watch with friends.}
\end{figure}
