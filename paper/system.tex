...
{\label{fig:browse}\includegraphics[width=0.45\textwidth]{pics/browse.png}}

\subfloat[Add shows from your WatchBox to your playlist] {\label{fig:watchbox}\includegraphics[width=0.45\textwidth]{pics/watchbox.png}}
...
\begin{figure}
\centering
\subfloat[Viewer chooses friends to watch with] {\label{fig:choosefriends}\includegraphics[width=0.4\textwidth]{pics/choosefriends.png}}


\subfloat[Viewer chooses from one of the three recommended shows] {\label{fig:chooseshows}\includegraphics[width=0.4\textwidth]{pics/chooseshow.png}}
...
\begin{figure}
\centering
\subfloat[Viewer chooses from a mood] {\label{fig:model1}\includegraphics[width=0.45\textwidth]{pics/mood.png}}
