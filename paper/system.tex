...
\begin{figure}
\centering \subfloat[Browse for shows and add them to your WatchBox]
           {\label{fig:model1}\includegraphics[width=0.45\textwidth]{pics/browse.png}}
           ~~\subfloat[Add shows from your WatchBox to your playlist]
           {\label{fig:model1}\includegraphics[width=0.45\textwidth]{pics/watchbox.png}}
...
\begin{figure}
\centering \subfloat[Viewer chooses from a mood]
           {\label{fig:model1}\includegraphics[width=0.45\textwidth]{pics/mood.png}}
           ~~\subfloat[Viewer chooses from a mood while watching with
             friends]
           {\label{fig:model1}\includegraphics[width=0.45\textwidth]{pics/choosefriends.png}}
...
\begin{figure}
\centering \subfloat[Playlist population based on your mood]
           {\label{fig:yourmood}\includegraphics[width=0.45\textwidth]{pics/youmoodrec.png}}
           ~~\subfloat[Recommendation based on you, your friends, and
             your mood]
           {\label{fig:groupmood}\includegraphics[width=0.45\textwidth]{pics/friendsmoodrec.png}}
