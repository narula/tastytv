...
{\label{fig:browse}\includegraphics[width=0.4\textwidth]{pics/browse.png}}

\subfloat[Add shows from your WatchBox to your playlist] {\label{fig:watchbox}\includegraphics[width=0.4\textwidth]{pics/watchbox.png}}
